test('test obj', () => {
  const data = { name: 'Bruno' }; // Para testear objetos se usa .toEqual.
  data.lastname = 'Diaz'; // Manipulación del objeto.
  expect(data).toEqual({ name: 'Bruno', lastname: 'Diaz' }); // Espero que el objeto de arriba sea igual a este.
});
